...
namespace BlueSky.Commands.Help
{
    public class HelpAboutCommand : BSkyCommandBase
    {
        ...
        protected override void OnExecute(object param)
        {
            ...
            MessageBox.Show("BlueSky Application x86 (Open Source Edition).\nVersion: "+strversion, "About BlueSky Application", MessageBoxButton.OK, MessageBoxImage.Information);
        }
